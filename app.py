...
def listarIndicadores():
    lista_indicadores = requests.get('https://api-evergreen-541.azurewebsites.net/indicadores').json()
...
def guardarIndicador():
    ...
    requests.post('https://api-evergreen-541.azurewebsites.net/indicadores', json=indicador)
